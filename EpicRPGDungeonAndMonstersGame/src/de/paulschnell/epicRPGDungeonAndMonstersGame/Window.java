...
public class Window extends JFrame {
	...
	private Waffe dildo = new Waffe(5, "Diamant", 0);
	...
	public Window() {
		...
		// Load
		helden = new Held[] { new Held("Elrike", 2, 1, 100, dildo, ""), new Held("Loud", 3, 2, 100, pancada, "/de/paulschnell/epicRPGDungeonAndMonstersGame/pancada.jpg") };

		monster = new Monster[] { new Monster(5, 100, "Günther und seine Crew von Olaf", "/de/paulschnell/epicRPGDungeonAndMonstersGame/g\u00FCnther_und_seine_crew_von_olaf.gif"), new Monster(10, 100, "Der schreckliche Sven", "/de/paulschnell/epicRPGDungeonAndMonstersGame/der_schreckliche_sven.jpg"), new Monster(15, 100, "OpTic Gaming", "/de/paulschnell/epicRPGDungeonAndMonstersGame/optic_gaming.png"), new Monster(20, 100, "Lord Garmadon", "/de/paulschnell/epicRPGDungeonAndMonstersGame/lord_garmadon.jpg"),
				new Monster(20, 100, "Der Fliegende Holländer", "/de/paulschnell/epicRPGDungeonAndMonstersGame/der_fliegende_hollander.png"), new Monster(25, 100, "Evil Morty", "/de/paulschnell/epicRPGDungeonAndMonstersGame/evil_morty.jpg"), new Monster(30, 100, "this mf", "/de/paulschnell/epicRPGDungeonAndMonstersGame/this_mf.jpg") };
		// Load
		...
		lblMonsterTitle.setBounds(663, 10, 113, 27);
		...
		btnKämpfen.setBounds(284, 471, 135, 40);
		...
		pbMonster.setBounds(420, 53, 260, 27);
		...
		lblFertig.setBounds(245, 176, 312, 98);
